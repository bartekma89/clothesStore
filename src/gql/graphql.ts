...
export type CollectionGetBySlugQuery = { collections: Array<{ id: string, name: string, description?: string | null, image: { width?: number | null, height?: number | null, url: string }, products: Array<{ id: string, name: string, price: number, slug: string, images: Array<{ width?: number | null, height?: number | null, url: string }> }> }> };
