...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ id: string, total: number, quantity: number, product?: { id: string, name: string, description: string, price: number, categories: Array<{ id: string, name: string }>, images: Array<{ url: string, width?: number | null, height?: number | null }> } | null }> } | null };
...
export type CollectionGetBySlugQuery = { collections: Array<{ id: string, name: string, description?: string | null, products: Array<{ id: string, name: string, price: number, slug: string, images: Array<{ width?: number | null, height?: number | null, url: string }> }> }> };
...
export type PaginationQuery = { productsConnection: { pageInfo: { hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null, pageSize?: number | null } } };
...
export const CartIdFragmentDoc = new TypedDocumentString(`
    fragment CartId on Order {
  id
}
    `, {"fragmentName":"CartId"}) as unknown as TypedDocumentString<CartIdFragment, unknown>;
...
export const PaginationDocument = new TypedDocumentString(`
  ...
  productsConnection(skip: $skip, first: $take) {
    ...
    `) as unknown as TypedDocumentString<PaginationQuery, PaginationQueryVariables>;
...
export const ProductsGetByCategoriesDocument = new TypedDocumentString(`
